...
##################################################################
array_index = np.array([])            # Arreglo en el que almacenamos los poligonos que la localidad de KENNEDY (numero 16 en polig_loc_df)
...
for i in range(0, len(poligonos_df)):
    ...
    poligonos_df.loc[i,'Núm de Estaciones de Policia'] = len(array1)
